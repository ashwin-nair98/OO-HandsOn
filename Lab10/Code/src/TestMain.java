public class TestMain {
	...
	// Create 4 objects of Employee by passing parameters (Hint: Parameterized Constructor)
		Employee emp1 = new Employee(1, "John", Roles.DEVELOPER , 20_000.0f, 10.0f, 5_000.0f);
		Employee emp2 = new Employee(2, "Doe", Roles.DESIGNER, 15_000.0f, 20.0f, 4_000.0f);
		Employee emp3 = new Employee(3, "Foo", Roles.SR_DEVELOPER, 30_000.0f, 15.0f, 7_000.0f);
		Employee emp4 = new Employee(4, "Bar", Roles.TEST_ENGINEER, 32_000.0f, 5.0f, 7_000.0f);
